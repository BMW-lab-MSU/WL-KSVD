...
#### https://github.com/chrsmrrs/tudataset/blob/master/tud_benchmark/auxiliarymethods/reader.py

import os.path as path
import networkx as nx


def tud_to_networkx(ds_path, ds_name):

    pre = ds_path+ "/" +ds_name + "/"

    with open( pre + ds_name + "_graph_indicator.txt", "r") as f:
    ...
    # Edges.
    with open(pre + ds_name + "_A.txt", "r") as f:
    ...
    # Node labels.
    if path.exists(pre + ds_name +"_node_labels.txt"):
        with open(pre + ds_name + "_node_labels.txt", "r") as f:
    ...
    # Node Attributes.
    if path.exists(pre + ds_name +"_node_attributes.txt"):
        with open(pre + ds_name + "_node_attributes.txt", "r") as f:
    ...
    # Edge Labels.
    if path.exists(pre + ds_name + "_edge_labels.txt"):
        with open(pre + ds_name + "_edge_labels.txt", "r") as f:
    ...
    # Edge Attributes.
    if path.exists(pre + ds_name + "_edge_attributes.txt"):
        with open(pre + ds_name + "_edge_attributes.txt", "r") as f:
    ...
    # Classes.
    if path.exists(pre + ds_name + "_graph_labels.txt"):
        with open(pre + ds_name + "_graph_labels.txt", "r") as f:
    ...
    class_names = tuple(i[0] for i in cs)

    # Targets.
    if path.exists(pre + ds_name + "_graph_attributes.txt"):
        with open(pre + ds_name + "_graph_attributes.txt", "r") as f:
